...
class C111Globals2D:
    def __init__(self):       
        ...
        self.GFD_MAX_TIMEOUT = 600 ;
        self.MHIT_MAX_TIMEOUT = 2450 ;
        self.GFD_FULL_MAX_VALUE = 4095 ;
        self.GFD_HALF_MAX_VALUE = 2047 ;
        self.GFD_QUART_MAX_VALUE = 1023 ;
        ...
        self.IDX_ENABLE_FINITE_TIME = 6 ; self.IDX_FINITE_TIME_LENGTH = 7 ;
        self.IDX_DISPLAY_UPDATE_INTERVAL = 8 ; self.IDX_BINNING = 9 ;
