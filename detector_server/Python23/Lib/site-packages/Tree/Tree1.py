...
class Node:
    ...
    def __init__(self, parent_node, id, collapsed_icon, x, y,
        ...
        sw.tag_bind(self.symbol, '<Any-Enter>', self.enter)
        sw.tag_bind(self.label, '<Any-Enter>', self.enter)
    ...
    def delete(self, me_too=1):
        ...
        if self.widget.pos == self and me_too:
            # move cursor if it points to current node
            self.widget.pos=self.parent_node
        ...
        if me_too:
            ...
            self.parent_node.PVT_cleanup_lines()
            self.parent_node=None
            
        self.widget.move_cursor(self.widget.pos)
