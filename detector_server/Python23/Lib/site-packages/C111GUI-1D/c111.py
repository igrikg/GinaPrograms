...
class c111:
   ...
   def setLibDebug(self,dbg_flag):
      ...
      """
      try:
        ret = c111py.c111py_setLibDebug(dbg_flag)
        return ret
      except:
        QMessageBox.warning(None,"Warning", "Cannot re-open connection to device")
        return -1
   ...
   def searchDev(self):
      ...
      """
      try:
        ret = c111py.c111py_searchDev()
        return ret
      except:
        QMessageBox.warning(None,"Warning", "Cannot perform device search ")
        return -1
   ...
   def open(self,device_name):
      ...
      """
      try:
        ret = c111py.c111py_open(device_name)
        return ret
      except:
        QMessageBox.warning(None,"Warning", "Cannot open connection to device ")
        return -1
   ...
   def reopen(self,device_name):
      ...
      """
      try:
        ret = c111py.c111py_reopen(device_name)
        return ret
      except:
        QMessageBox.warning(None,"Warning", "Cannot re-open connection to device ")
        return -1
   ...
   def close(self,FD):
      ...
      """
      try:
        ret = c111py.c111py_close(FD)
        return ret
      except:
        QMessageBox.warning(None,"Warning", "Cannot close connection to device ")
        return -1
   ...
   def setDriverDebug(self,FD,level):
      ...
      """
      try:
        ret = c111py.c111py_setDbgLevel(FD,level)
        return ret
      except:
        QMessageBox.warning(None,"Warning", "Cannot set debug level on device ")
        return -1
   ...
   def loadVirtex(self,FD,bootconfig, bitfilepath):
      ...
      """
      try:
        ret = c111py.c111py_loadVirtex(FD,bootconfig,bitfilepath)
        return ret
      except:
        QMessageBox.warning(None,"Warning", "Cannot download virtex to device ")
        return -1
   ...
   def getBootConfig(self,FD):
      ...
      """
      try:
        ret = c111py.c111py_getBootConfig(FD)
        return ret
      except:
        QMessageBox.warning(None,"Warning", "Cannot get operation mode from device ")
        return -1
 ...
 *
      """
      try:
        ret = c111py.c111py_getCubStatus(FD)
        return ret
      except:
        QMessageBox.warning(None,"Warning", "Cannot get cub status from device ")
        return -1
   ...
   def setTdcConfig(self,FD,c111_listtdcconfig):
    ...
    config->acq_bank          = 0; /* will be filled on return */
      ...
      """
      try:
        ret = c111py.c111py_setTdcConfig(FD,c111_listtdcconfig)
        return ret
      except:
        QMessageBox.warning(None,"Warning", "Cannot set TDC config to device ")
        return -1
   ...
   def getTdcConfig(self,FD):
    ...
    config->acq_bank          = 0; /* will be filled on return */
      ...
      """
      try:
        ret = c111py.c111py_getTdcConfig(FD)
        return ret
      except:
        QMessageBox.warning(None,"Warning", "Cannot get TDC config from device ")
        return -1
   ...
   def getTdcConfigHw(self,FD):
      ...
      """
      try:
        ret = c111py.c111py_getTdcConfigHw(FD)
        return ret
      except:
        QMessageBox.warning(None,"Warning", "Cannot get TDC config from device ")
        return -1
   ...
   def setPowerUpDn(self,FD,pupdn):
      ...
      """
      try:
        ret = c111py.c111py_setPowerUpDn(FD,pupdn)
        return ret
      except:
        QMessageBox.warning(None,"Warning", "Cannot set power up/down on device ")
        return -1
   ...
   def getPowerUpDn(self,FD):
      ...
      """
      try:
        ret = c111py.c111py_getPowerUpDn(FD)
        return ret
      except:
        QMessageBox.warning(None,"Warning", "Cannot get power up/down from device ")
        return -1
   ...
   def setAcqBank(self,FD,bank_id):
      ...
      """
      try:
        ret = c111py.c111py_setAcqBank(FD,bank_id)
        return ret
      except:
        QMessageBox.warning(None,"Warning", "Cannot set acquisition bank on device ")
        return -1
   ...
   def initBank(self,FD,init_value,incr_flag):
      ...
      """
      try:
        ret = c111py.c111py_initBank(FD,init_value,incr_flag)
        return ret
      except:
        QMessageBox.warning(None,"Warning", "Cannot init acquisition bank on device ")
        return -1
   ...
   def startTdc(self,FD,time_sft):
      ...
      try:
        ret = c111py.c111py_startTdc(FD,time_sft)
        return ret
      except:
        QMessageBox.warning(None,"Warning", "Cannot start TDC on device ")
        print "error: ", c111py.error
        return -1
   ...
   def stopTdc(self,FD):
      ...
      """
      try:
        ret = c111py.c111py_stopTdc(FD)
        return ret
      except:
        QMessageBox.warning(None,"Warning", "Cannot stop TDC on device ")
        return -1
   ...
   def getTdcStatus(self,FD):
      ...
      """
      try:
        ret = c111py.c111py_getTdcStatus(FD)
        return ret
      except:
        QMessageBox.warning(None,"Warning", "Cannot get TDC from device ")
        return -1
 ...
 *                                  - GFD only: nb of ALU overflow events 
   ...
   def readHistogram(self,FD,c111_listtdcconfig,c111_listreadhist):
      """
      ...
      if( sys.platform == "win32"):
          ...
          return c111py.c111py_readHistogram(FD, c111_listtdcconfig, c111_listreadhist)
